        ...
        <div class="row">
            <div class="col-md-8" style="margin-bottom: 10px;">
               <p class="text-on-image">
                   <br>
                  <i> <small>text on image </small></i>
               </p>
                <a href="http://error404.000webhost.com/?">
                    <img class="img-responsive img-hover" src="img/HD1.jpg" alt="" id="week"> 
             ...
             <div class="row">    
                    <br>
                      <div class="col-md-2 col-sm-3 text-center">
                              <a href="blogg/post.html"><img alt="" class="img-circle img-responsive blog style" style=" " src="img/shobhamam.jpg"></a>
                      </div>
...
<p><a href="mailto:scienceoutreachdu@gmail.com" style="color:white;" class="email btn btn-lg "><span class="glyphicon glyphicon-envelope sec" style="height:50px; width:50px;"></span></a></p>
  ...
  <script type="text/javascript">
    <script type="text/javascript">
        ...
        function loadMaths(response) {
            var input = '<div class="item active">';
                input += '<div class="row">';

                input += '<br>';
                input += '<div class="col-md-2 col-sm-3 text-center">';
                input += '<a href="blogg/post.html">';
                input += '<img src='' class="img-circle img-responsive blog" style="width:120px;height:120px; margin-left:10px;">';
