        ...
        <li class="dropdown">
         ...
         <li ><a href="#" style="color:black" >Interview</a></li>
           ...
           <li ><a href="#" style="color:black" >Research Reviews</a></li>
            <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown"style="color:black">Media</a>
      <!--    <ul class="dropdown-menu">
            <li><a href="#" style="color:black" >Peer review</a></li>
            <li><a href="#" style="color:black" >Documentry</a></li>
            <li><a href="#" style="color:black" >Internview</a></li>
          </ul>-->
        </li> 
         <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color:black">Policy<b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="#" style="color:black" style="color:black">Education</a></li>
            <li><a href="#" style="color:black" style="color:black">Environment</a></li>
              <li><a href="#" style="color:black" style="color:black">Wild life and Forest</a></li>
                <li><a href="#" style="color:black" style="color:black">Bio-diversity</a></li>
