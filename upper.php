      ...
      <ul class="nav navbar-nav" style="color:black">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="#" style="color:black" >Physical Science</a></li>
            <li><a href="#" style="color:black" >Life Science</a></li>
            <li><a href="#" style="color:black" >Environment &amp; Health</a></li>
            <li><a href="#" style="color:black" >Technology</a></li>
            <li><a href="#" style="color:black" >Mathematics</a></li>
          </ul>
        </li>
         ...
         <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="#" style="color:black" style="color:black">Environment Policy</a></li>
