  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
   ...
   <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="img/HD1.jpg" alt="Chania" class="img-responsive" style="height: 400px;">
      </div>

      <div class="item">
        <img src="blogg/img/maths.jpg" alt="Chania" class="img-responsive" style="height: 400px;">
      </div>
    
      <div class="item">
        <img src="blogg/img/quiz.jpg" alt="Flower" class="img-responsive" style="height: 400px;">
      </div>

      <div class="item">
        <img src="blogg/img/shobhamam.jpg" alt="Flower" class="img-responsive" style="height: 400px;">
      </div>
    ...
    <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
      ...
      <span class="sr-only">Next</span>
            ...
            <a href="#"  class="list-group-item active" style="font-family: 'Dancing Script', cursive;font-size:30px; padding:10px; margin-bottom:10px; margin-top: 20px;">Photo of the Week</a>
